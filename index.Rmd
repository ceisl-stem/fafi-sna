...
* Understanding the "unruly" nature of educational justice work and the networks that
...
Computer scientist Don Knuth first coined the term "literate code" as a phrase to indicate
that programming should be in the form of a human-readable narrative. It has been taken up
...
In this case, as a community-engaged study more interested in deomonstrating
trustworthiness and transparency, literate code provides a clear window for community
members and participants into the inner processes of data analysis and visualization
techniques.

I'm a bricoleur, so the code itself is not great.
