...
![Grid of Social Network Plots](aux/grid-key.png)
...
```{r unruly-timeline, echo = TRUE, layout="l-body-outset", results = TRUE, eval = FALSE}
...
```{r save-timeline, echo = FALSE, purl = FALSE, dpi=300, eval = FALSE}
# Save a copy of the network to be displayed below
